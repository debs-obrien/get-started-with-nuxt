  ...
  <section class="container">
    ...
    <section class="sub-section">
      ...
      <pre class="source-terminal"><code>
        <span>npm i node-sass sass-loader</span>
      </code></pre>
    </section>
    ...
    <section class="sub-section">
      ...
      <pre class="source-nuxt-config"><code>
        <span>css: ['~assets/scss/styles.scss'],</span>
      </code></pre>
    </section>
    ...
    <section class="sub-section">
      ...
      <pre class="source-terminal"><code>
        <span>npm i @nuxtjs/style-resources</span>
      </code></pre>
      ...
      <pre class="source-nuxt-config"><code>
        <span>modules: [</span>
          <span>['@nuxtjs/style-resources']</span>
        <span>],</span>
        <span>styleResources: {</span>
          <span>scss: ['~assets/scss/variables.scss'], </span>
        <span>}</span>
      </code></pre>
    ...
    <section class="sub-section">
      ...
      <pre class="source-styles-variables"><code>
      ...
      <pre class="source-component-vue"><code>
        <span>&#60;style lang="scss" scoped&#62;</span>
      </code></pre>
      ...
      <pre class="source-styles"><code>
        <span>body {</span>
          <span>background-color: $primary;</span>
        <span>}</span>
      </code></pre>
    ...
    <section class="sub-section">
      ...
      <p>This is a very handy tool especially if you are working with frameworks like like Bootstrap, Materializecss, Foundation, etc... where you will only use a small set of the framework and a lot of unused css styles will be included.</p>
      <p>Purgecss analyzes your content and your css files and matches the selectors used in your files with the one in your content files. It removes unused selectors from your css, resulting in smaller css files</p>
      <pre class="source-terminal"><code>
        <span>npm i nuxt-purgecss</span>
      </code></pre>
      <p>Next add nuxt purgecss to the moudles section in your nuxt.config</p>
      <pre class="source-nuxt-config"><code>
        <span>modules: [</span>
          <span>'nuxt-purgecss',</span>
        <span>],</span>
      </code></pre>
    </section>
  </section>
